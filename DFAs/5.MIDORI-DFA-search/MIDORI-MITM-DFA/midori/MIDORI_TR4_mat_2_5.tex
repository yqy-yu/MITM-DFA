...
\draw (1,0) node{\tiny $\oplus$};
  ...
  \draw[draw=gray!80,fill=red] (1.0,1.5) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,fill=blue] (1.5,1.0) rectangle +(0.5,0.5);
...
\draw[->] (6,1.5) -- ++(-1,0);
  ...
  \draw[fill=gray] (3.5,0.5) rectangle +(0.5,0.5);
...
\draw (7,3) node{\tiny $\oplus$};
  ...
  \draw[draw=gray!80,fill=red] (7.0,5.0) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (6.5,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (7.0,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=blue] (7.5,4.5) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (6.5,3.5) rectangle +(0.5,0.5);
