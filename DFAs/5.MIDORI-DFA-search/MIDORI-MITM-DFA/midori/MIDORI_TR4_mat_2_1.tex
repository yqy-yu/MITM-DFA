...
\draw (1,0) node{\tiny $\oplus$};
  ...
  \draw[draw=gray!80,fill=blue] (0.0,1.0) rectangle +(0.5,0.5);
...
\draw (7,3) node{\tiny $\oplus$};
  \draw[draw=gray!80,fill=blue] (6.0,5.0) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,fill=blue] (6.0,4.5) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,fill=red] (7.5,4.5) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,fill=red] (7.5,4.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=blue] (6.0,3.5) rectangle +(0.5,0.5);
  ...
  \draw[draw=gray!80,fill=red] (7.5,3.5) rectangle +(0.5,0.5);
