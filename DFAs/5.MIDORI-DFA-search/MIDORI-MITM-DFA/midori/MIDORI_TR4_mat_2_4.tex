...
\draw(1,0) node {$X_{R-1}$};
  ...
  \draw[fill=gray] (0.5,2.0) rectangle +(0.5,0.5);
  \draw[fill=gray] (1.0,2.0) rectangle +(0.5,0.5);
  \draw[fill=blue] (1.5,2.0) rectangle +(0.5,0.5);
  \draw[fill=gray] (0.0,1.5) rectangle +(0.5,0.5);
...
\draw (1,0) node{\tiny $\oplus$};
  ...
  \draw[draw=gray!80,fill=red] (0.0,0.5) rectangle +(0.5,0.5);
...
\draw[->] (6,1.5) -- ++(-1,0);
  \draw[fill=red] (3.0,2.0) rectangle +(0.5,0.5);
  \draw[fill=gray] (3.5,2.0) rectangle +(0.5,0.5);
  \draw[fill=blue] (4.0,2.0) rectangle +(0.5,0.5);
  \draw[fill=gray] (4.5,2.0) rectangle +(0.5,0.5);
  \draw[fill=red] (3.0,1.5) rectangle +(0.5,0.5);
  \draw[fill=gray] (3.5,1.5) rectangle +(0.5,0.5);
  \draw[fill=blue] (4.0,1.5) rectangle +(0.5,0.5);
  \draw[fill=gray] (4.5,1.5) rectangle +(0.5,0.5);
  \draw[fill=red] (3.0,1.0) rectangle +(0.5,0.5);
  ...
  \draw[fill=blue] (4.0,0.5) rectangle +(0.5,0.5);
...
\draw (7,3) node{\tiny $\oplus$};
  ...
  \draw[draw=gray!80,fill=blue] (7.0,3.5) rectangle +(0.5,0.5);
