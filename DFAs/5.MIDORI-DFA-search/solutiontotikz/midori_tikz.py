...
f=open('MIDORI_TR'+str(TR)+'_mat_'+str(mat)+'.tex','w')
...
for r in range(0, mat):
    f.write(r'\begin{scope}[yshift=' + str(20 - 4 * ((r+1) // 2)) + 'cm]' + '\n' + r'   \begin{scope}[xshift=' + str(
        -10 + 9 * ((r+1) % 2)) + 'cm]' + '\n')
    f.write(r'\path (4,-0.5) node {\tiny round $R' + str(r - TR) + '$};' + '\n')
    f.write(r'\draw[->] (2,1.5) -- ++(1,0);' + '\n')
    f.write(r'\draw[thin] (2.5,1.5) -- node[above] {\tiny \tt SB} +(0,0);' + '\n')
    f.write(r'\draw(1,0) node {$X_{R' + str(r - TR) + '}$};' + '\n')
    for i in range(0, 4):
        for j in range(0, 4):
    ...
    f.write(r'\draw[->] (2,1.5) -- ++(1,0);' + '\n')
    f.write(r'\draw(1,0) node {$Y_{R' + str(r - TR) + '}$};' + '\n')
    for i in range(0, 4):
        for j in range(0, 4):
    ...
    f.write(r'\draw[->] (2,1.5) -- ++(1,0);' + '\n')
    f.write(r'\draw(1,0) node {$Z_{R' + str(r - TR) + '}$};' + '\n')
    for i in range(0, 4):
        for j in range(0, 4):
...
for r in range(mat, TR):
    if r == mat:
        ...
        for i in range(0, 4):
            for j in range(0, 4):
                f.write(r'  \draw[fill=' + Zcolor[16 * mat + 4 * i + j] + '] (' + str(j / 2) + ',' + str(
                    2 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')
        f.write(r'	\end{scope}' + '\n' + r'    \end{scope}' + '\n')
    else:
        f.write(r'\begin{scope}[yshift=' + str(
            20 - 4 * (mat// 2) - 7 * (((r+1) - mat) // 2)) + 'cm]' + '\n' + r'   \begin{scope}[xshift=' + str(
            -10 + 9 * ((r+1) % 2)) + 'cm]' + '\n')
        f.write(r'\path (4,-0.5) node {\tiny round $R' + str(r - TR) + '$};' + '\n')
        ...
        for i in range(0, 4):
            for j in range(0, 4):
                f.write(r'  \draw[fill=' + sccolor[16 * (r - mat - 1) + 4 * i + j] + '] (' + str(j / 2) + ',' + str(
                    2 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')
        f.write(r'	\end{scope}' + '\n' + r'    \end{scope}' + '\n')

        f.write(r'\begin{scope}[yshift=' + str(
            23 - 4 * (mat // 2) - 7 * (((r+1) - mat) // 2)) + 'cm]' + '\n' + r'   \begin{scope}[xshift=' + str(
            -4 + 9 * ((r+1) % 2)) + 'cm]' + '\n')
        f.write(r'\draw (2.5,1.5) node{\tiny {$K_0$}};' + '\n')
        ...
        if r != TR - 1:
            ...
            f.write(r'\draw[thin] (2.5,1.5) -- node[above] {\tiny \tt MC} +(0,0);' + '\n')
            f.write(r'\draw[->] (3,1.5) -- ++(-1,0);' + '\n')
            f.write(r'\path (7,-0.5) node {\tiny round $R' + str(r +1 - TR) + '$};' + '\n')
            f.write(r'\draw(1,0) node {$Z_{R' + str(r - TR) + '}$};' + '\n')
            for i in range(0, 4):
                for j in range(0, 4):
                    f.write(r'  \draw[fill=' + mccolor[16 * (r - mat - 1) + 4 * i + j] + '] (' + str(j / 2) + ',' + str(
                        2 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')
            f.write(r'\draw(4,0) node {$X_{R' + str(r + 1 - TR) + '}$};' + '\n')
            f.write(r'\draw[thin] (5.5,1.5) -- node[above] {\tiny \tt SB} +(0,0);' + '\n')
            f.write(r'\draw[->] (6,1.5) -- ++(-1,0);' + '\n')
            for i in range(0, 4):
                for j in range(0, 4):
                    f.write(
                        r'  \draw[fill=' + sbcolor[16 * (r - mat) + 4 * i + j] + '] (' + str(3 + j / 2) + ',' + str(
                            2 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')

            f.write(r'\draw(7,0) node {\tiny \tt ciphertext};' + '\n')
            for i in range(0, 4):
                for j in range(0, 4):
                    f.write(r'  \draw[fill=gray] (' + str(6 + j / 2) + ',' + str(
                        2 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')

            f.write(r'\draw (9,4.5) node{\tiny {$K_0 \oplus K_1$}};' + '\n')
            f.write(r'\draw (7,3) node{\tiny $\oplus$};' + '\n')
            for i in range(0, 4):
                for j in range(0, 4):
                    if sbcolor[16 * (r - mat) + 4 * i + j] != 'gray':
                        f.write(r'  \draw[draw=gray!80,fill=' + sbcolor[16 * (r - mat) + 4 * i + j] + '] (' + str(
                            6 + j / 2) + ',' + str(5 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')
                    else:
                        f.write(r'  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (' + str(
                            6 + j / 2) + ',' + str(5 - i / 2) + ') rectangle +(0.5,0.5);' + '\n')
            f.write(r'\draw[line width =1pt] (6,3.5) rectangle +(2,2);' + '\n')
...
f.write(r'\begin{scope}[shift={(-3,5)}]'+'\n')
