...
\path (-1,-0.5) node {\tiny round $R-3$};
\draw[->,dashed] (-1,1.5) -- ++(1,0);
\draw[->] (2,1.5) -- ++(1,0);
\draw[thin] (2.5,1.5) -- node[above] {\tiny ${\texttt{SB}}^{-1}$} +(0,0);
...
\draw[->] (2,1.5) -- ++(1,0);
\draw[thin] (2.5,1.5) -- node[above] {\tiny ${\texttt{SR}}^{-1}$} +(0,0);
...
\draw(1,0) node {$Z_{R0}$};
  ...
  \draw[fill=gray] (0.5,1.0) rectangle +(0.5,0.5);
  \draw[fill=red] (1.0,1.0) rectangle +(0.5,0.5);
  \draw[fill=gray] (1.5,1.0) rectangle +(0.5,0.5);
  \draw[fill=blue] (0.0,0.5) rectangle +(0.5,0.5);
  \draw[fill=gray] (0.5,0.5) rectangle +(0.5,0.5);
  \draw[fill=red] (1.0,0.5) rectangle +(0.5,0.5);
  \draw[fill=gray] (1.5,0.5) rectangle +(0.5,0.5);
\draw(4,0) node {\tiny \tt ciphertext};
...
\draw (6,4.5) node{\tiny {$K_0 \oplus K_1$}};
\draw (4,3) node{\tiny $\oplus$};
  \draw[draw=gray!80,fill=blue] (3.0,5.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (3.5,5.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=red] (4.0,5.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (4.5,5.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=blue] (3.0,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (3.5,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=red] (4.0,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (4.5,4.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=blue] (3.0,4.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (3.5,4.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=red] (4.0,4.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (4.5,4.0) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=blue] (3.0,3.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (3.5,3.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,fill=red] (4.0,3.5) rectangle +(0.5,0.5);
  \draw[draw=gray!80,pattern = north west lines, pattern color = darkgreen] (4.5,3.5) rectangle +(0.5,0.5);
\draw[line width=1pt] (3,3.5) rectangle +(2,2);
	\end{scope}
    \end{scope}
