...
{   
    ...
    for (int sample_num = 0; sample_num < 1000; sample_num++) {
        for (int i = 0; i < 16; i++)
        {  
        ...
        /*if (samplenum != 0) {
            swap(haocai[2*sample_num], Delta_key_x_1);
            swap(haocai[2*sample_num+1], Delta_key_x_13);
        }*/
        ...
        for (int i = 0; i < 256*isBreak; i++) {
            for (int j = 0; j < 256*isBreak; j++) {                                     // Exclusively-Search phase
                for (int k = 0; k < 256*isBreak; k++) {
                    for (int line = 0; line < num_3; line++) {
                        ...
                        if (flag) {
                            ...
                            for (int l = 0; l < 16; l++) {
                                cout << hex << (int)tweakeys[sample_num][l] << " ";
                            }
                            cout << endl;
                            ...
                            fstream outfile;
                            outfile.open("data_sample.txt",ios::app);
                            outfile << (int)num_1 << " " << (int)num_2 << " " << num_3 << " " << endl;
                            outfile.close();
                            isBreak = 0;
                        }
                    }
